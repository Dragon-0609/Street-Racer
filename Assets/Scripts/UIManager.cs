...
public class UIManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        carHolder.transform.position -=
            Vector3.right * 8 * currentSelectedCarIndex; //set the car holder position to respective selected car
    ...
    public void SelectCarButton() //method called by Select car button
    {
        ...
        LevelManager.Instance.PlayerController.SpawnVehicle(GameManager.singeton
            .currentCarIndex); //spawn the respective car
